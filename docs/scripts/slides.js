...
function speedSizeSlides() {
  return [
    '03-1-speed-size/01-title.md',
    '03-1-speed-size/02-float-line.md',
    '03-1-speed-size/10-intro.md',
    '03-1-speed-size/11-example.md',
    '03-1-speed-size/12-lcp.md',
    '03-1-speed-size/13-lcp-calc.md',
    '03-1-speed-size/14-speed-index.md',
    '03-1-speed-size/15-speed-index-calc.md',
    '03-1-speed-size/16-speed-index-example.md',
    '03-1-speed-size/17-causes.md',
    '03-1-speed-size/20-images.md',
    '03-1-speed-size/21-format.md',
    '03-1-speed-size/22-example.md',
    '03-1-speed-size/23-responsive-image.md',
    '03-1-speed-size/24-dpr.md',
    '03-1-speed-size/25-lazyload.md',
    '03-1-speed-size/30-coverage.md',
    '03-1-speed-size/31-coverage-screen.md',
    '03-1-speed-size/32-coverage-solution.md',
    '03-1-speed-size/33-coverage-split.md',
    '03-1-speed-size/34-coverage-clean.md',
    '03-1-speed-size/35-coverage-dynamic.md',
    '03-1-speed-size/40-compression.md',
    '03-1-speed-size/41-compression-intro.md',
    '03-1-speed-size/42-minification.md',
    '03-1-speed-size/43-compression.md',
    ...
    '03-1-speed-size/53-cache-public.md',
    '03-1-speed-size/54-bfcache.md',
    '03-1-speed-size/55-serviceworker.md',
    '03-1-speed-size/56-cache-recap.md',
  ];
}

function speedCriticalSlides() {
  return [
    '03-2-speed-critical/50-loading-javascript.md',
    '03-2-speed-critical/51-order.md',
    '03-2-speed-critical/52-preload.md',
    '03-2-speed-critical/53-preload-prefetch.md',
    '03-2-speed-critical/54-defer-async.md',
    '03-2-speed-critical/55-fetchpriority.md',
    '03-2-speed-critical/60-blocking.md',
    '03-2-speed-critical/61-blocking-js.md',
    '03-2-speed-critical/62-blocking-server.md',
    '03-2-speed-critical/70-http.md',
    '03-2-speed-critical/71-http-intro.md',
    '03-2-speed-critical/72-http1.md',
    '03-2-speed-critical/73-http1.1.md',
