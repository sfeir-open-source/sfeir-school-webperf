...
function speedSlides() {
  return [
    ...
    '03-speed/16-causes.md',
    '03-speed/20-images.md',
    '03-speed/21-format.md',
    '03-speed/22-example.md',
    '03-speed/23-responsive.md',
    '03-speed/24-aspect-ratio.md',
    '03-speed/25-example.md',
    '03-speed/26-lazyload.md',
    '03-speed/27-example.md',
    '03-speed/28-preload.md',
