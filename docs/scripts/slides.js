...
function speedSlides() {
  return [
    ...
    '03-speed/22-01-example-1.md',
    '03-speed/22-02-example-2.md',
    '03-speed/22-03-example-3.md',
    '03-speed/22-04-example-4.md',
    '03-speed/22-05-example-5.md',
    '03-speed/23-01-responsive-picture.md',
    '03-speed/23-02-responsive-sizes.md',
    '03-speed/23-03-responsive-both.md',
    '03-speed/23-04-responsive-summary.md',
    '03-speed/24-dpr.md',
    '03-speed/25-lazyload.md',
    '03-speed/26-example.md',
    '03-speed/27-01-preload.md',
    '03-speed/27-02-usage.md',
    '03-speed/27-03-preload-prefetch.md',
    '03-speed/27-04-example.md',
    '03-speed/30-loading-javascript.md',
    '03-speed/31-strategy.md',
    '03-speed/32-defer.md',
    '03-speed/33-async.md',
    '03-speed/34-module.md',
    '03-speed/35-frameworks.md',
